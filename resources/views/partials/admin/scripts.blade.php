    ...
    <script src="{{ asset('public/js/utils/qrcode.min.js') }}"></script>
    <script src="{{ asset('public/js/utils/qrcode.util.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        $("#btn-study-status").click(function() {
            $('#loading').addClass('loading');
            $('#loading-content').addClass('loading-content');
        });
        ...
        const mutationObserver = new MutationObserver(function (mutations) {
            mutations.forEach(function (mutation) {
                if (mutation.target.classList && mutation.target.classList.contains('has-error')) {
