...
class Form extends Provider
{
    ...
    public function boot()
    {
        ...
        Facade::component('dateSimpleGroup', 'partials.form.date_simple_group', [
            'name', 'text', 'icon', 'attributes' => ['required' => 'required'], 'value' => null, 'col' => 'col-md-6', 'group_class' => null
        ]);
        ...
        Facade::component('deleteLinkUuid', 'partials.form.delete_link_uuid', [
            'item', 'url', 'text' => '', 'value' => 'name', 'uuid' => 'uuid',
        ]);
